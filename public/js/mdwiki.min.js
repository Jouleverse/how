...
function marked(src, opt, callback) {
  ...
  try {
    ...
    e.message += '\nPlease report this to gh/chjj/marked.';
...
(function($) {
    ...
    // use vanilla JS. See:
    // stackoverflow/questions/610995/jquery-cant-append-script-element
...
*/
    ...
    function adjustExternalContent() {
        ...
        // by gimmicks
        // example: video iframes, maps div canvas
    ...
    function addFooter() {
        ...
        navbar +=     'Website generated with MDwiki ';
...
//// remove forkmeongh by liujiaolian
//// remove lazygist by liujiaolian
//// remove discus, fb, tw, gmaps gimmicks by liujiaolian
...
(function($) {
    ...
    function load_mathjax($links, opt, ref) {
        ...
        var script = document.createElement('script');
        script.type = 'text/javascript';
        script.src  = $.md.prepareLink('/public/js/MathJax.js?config=TeX-AMS-MML_HTMLorMML', { forceHTTP: true });
